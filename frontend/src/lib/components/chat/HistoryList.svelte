<script lang="ts">
	...
	const filteredSessions = $derived(
		chat.sessions.filter((s) => s.kind === chat.historyTab),
	);
...
<div class="history-list" onclick={handleClickOutside}>
	<div class="history-list__header">
		<h2 class="history-list__title">History</h2>
		<div class="history-list__tabs" role="tablist">
			<button
				class="history-list__tab"
				class:history-list__tab--active={chat.historyTab === 'story'}
				role="tab"
			...
			<button
				class="history-list__tab"
				class:history-list__tab--active={chat.historyTab === 'character'}
				role="tab"
	...
	<div class="history-list__items">
		{#if filteredSessions.length === 0}
			<p class="history-list__empty">No {chat.historyTab} sessions yet.</p>
		{/if}
